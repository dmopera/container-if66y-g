...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-if66y-g.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-if66y-g.containers.anotherwebservice.com/
...
```
git clone git@github.com:dmopera/container-if66y-g.git
cd container-if66y-g
```
...
```
docker attach container-if66y-g
```
